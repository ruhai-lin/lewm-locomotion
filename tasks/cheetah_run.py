...
* ``goal_frame_mask`` thresholds (cheetah runs belly-low; filter on speed).
...
DATASET_VERSION = 6  # bumped: single perturbed.npz; burst after warmup; no goal_manifold viz.
